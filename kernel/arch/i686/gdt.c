...
void gdt_init(void)
{
    ...
    gdt_set_gate(KERNEL_CODE_SEGMENT, NULL_SEGMENT, UINT32_INVALID, ACCESS_KERNEL_CODE, GRANULARITY); // Kernel code
    gdt_set_gate(KERNEL_DATA_SEGMENT, NULL_SEGMENT, UINT32_INVALID, ACCESS_KERNEL_DATA, GRANULARITY); // Kernel data
    gdt_set_gate(USER_CODE_SEGMENT, NULL_SEGMENT, UINT32_INVALID, ACCESS_USER_CODE, GRANULARITY); // User code
    gdt_set_gate(USER_DATA_SEGMENT, NULL_SEGMENT, UINT32_INVALID, ACCESS_USER_DATA, GRANULARITY); // User data
